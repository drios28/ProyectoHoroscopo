...
$registro = [];
if (isset($_GET["id"])) {
    $registro = obtener_registroChino($servername, $username, $password, $dbname, $_GET["id"]);
}
...
<form method="post" action="actualizar_chino.php<?php echo isset($_GET["id"]) ? "?id=" . $_GET["id"] : ""; ?>">
    <div class="container">
        <h2>Actualización de Predicciones de Horóscopo Chino</h2>
...
if (isset($_POST["grabar"])) {
    ...
    $sql = "UPDATE zodiaco_chino SET signo = '" . $signo . "', prediccion = '" . $prediccion . "' WHERE id = " . $id;
